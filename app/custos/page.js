...
const COST_TYPES = [
  ...
  { id: 'sms', label: 'SMS', icon: 'M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z', color: '#10B981' },
            ...
            <motion.div
              ...
              style={{
                ...
                background: kpis.lucroLiquido>=0
                  ? 'linear-gradient(145deg, rgba(16,185,129,0.08), rgba(14,22,38,0.7))'
                  : 'linear-gradient(145deg, rgba(239,68,68,0.08), rgba(14,22,38,0.7))',
                backdropFilter:'blur(16px) saturate(150%)', WebkitBackdropFilter:'blur(16px) saturate(150%)',
                border: `1px solid ${kpis.lucroLiquido>=0?'rgba(16,185,129,0.18)':'rgba(239,68,68,0.18)'}`,
                boxShadow: `0 8px 28px rgba(0,0,0,0.4), 0 0 32px ${kpis.lucroLiquido>=0?'rgba(16,185,129,0.08)':'rgba(239,68,68,0.08)'}, inset 0 1px 0 rgba(255,255,255,0.04)`,
                position: 'relative', overflow: 'hidden',
              }}
            >
              {/* subtle glow */}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 700, color: '#10B981', fontFamily: 'var(--mono)' }}>R$ {fmt(kpis.lucroHoje)}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{
                  ...
                  color: kpis.lucroLiquido >= 0 ? '#10B981' : '#EF4444',
                }}>
