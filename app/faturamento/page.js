        ...
        {tab==='overview' && (<div key="ov" className="tab-content">
          ...
          <div className="g-side" style={{display:'grid',gridTemplateColumns:'1.6fr 1fr',gap:16,marginBottom:24}}>
            ...
            <div style={{
              ...
              border:`1px solid ${stats.lucroFinal>=0?'rgba(236,253,245,0.18)':'rgba(239,68,68,0.18)'}`,
              boxShadow:`0 10px 40px rgba(0,0,0,0.5), 0 0 60px ${stats.lucroFinal>=0?'rgba(236,253,245,0.08)':'rgba(239,68,68,0.08)'}, inset 0 1px 0 rgba(255,255,255,0.05)`,
            }}>
              <div style={{position:'absolute',top:'5%',left:'0%',width:500,height:380,borderRadius:'50%',background:`radial-gradient(circle, ${stats.lucroFinal>=0?'rgba(236,253,245,0.13)':'rgba(239,68,68,0.13)'}, transparent 60%)`,filter:'blur(60px)',pointerEvents:'none'}}/>
              <div style={{position:'absolute',top:0,left:'12%',right:'12%',height:1,background:`linear-gradient(90deg, transparent, ${stats.lucroFinal>=0?'rgba(236,253,245,0.5)':'rgba(239,68,68,0.5)'}, transparent)`,pointerEvents:'none'}}/>
              ...
              <svg style={{ position:'absolute', bottom:0, left:0, right:0, pointerEvents:'none', opacity:0.22 }} viewBox="0 0 400 80" preserveAspectRatio="none" width="100%" height="80">
                <defs>
                  <linearGradient id="fatHeroArea" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stopColor={stats.lucroFinal>=0?'#ECFDF5':'#EF4444'} stopOpacity="0.2"/>
                    <stop offset="100%" stopColor={stats.lucroFinal>=0?'#ECFDF5':'#EF4444'} stopOpacity="0"/>
                  </linearGradient>
                </defs>
                ...
                <path d="M0,60 L40,55 L80,48 L120,50 L160,40 L200,34 L240,38 L280,26 L320,20 L360,12 L400,6" fill="none" stroke={stats.lucroFinal>=0?'#ECFDF5':'#EF4444'} strokeWidth="1.8" strokeLinecap="round" strokeOpacity="0.6"/>
              </svg>

              <div style={{position:'relative',zIndex:1}}>
                <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:6 }}>
                  <div style={{ width:3, height:12, borderRadius:2, background: stats.lucroFinal>=0?'#ECFDF5':'#EF4444', boxShadow:`0 0 10px ${stats.lucroFinal>=0?'rgba(236,253,245,0.7)':'rgba(239,68,68,0.7)'}` }}/>
                ...
                <p style={{fontFamily:'var(--mono)',fontSize:56,fontWeight:900,lineHeight:1,letterSpacing:'-0.035em',margin:'0 0 10px',
                  ...
                  textShadow:`0 0 70px ${stats.lucroFinal>=0?'rgba(236,253,245,0.25)':'rgba(239,68,68,0.25)'}`,
                }}>
                ...
                {predictions.pctChange!==0 ? (
                  <div style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'5px 11px', borderRadius:7,
                    background: predictions.pctChange>0?'rgba(236,253,245,0.1)':'rgba(239,68,68,0.1)',
                    border:`1px solid ${predictions.pctChange>0?'rgba(236,253,245,0.22)':'rgba(239,68,68,0.22)'}`,
                  }}>
                    <svg width={11} height={11} viewBox="0 0 24 24" fill="none" stroke={predictions.pctChange>0?'#ECFDF5':'#EF4444'} strokeWidth="2.5" strokeLinecap="round">
                      <polyline points={predictions.pctChange>0?"23 6 13.5 15.5 8.5 10.5 1 18":"1 18 10.5 8.5 15.5 13.5 23 6"}/>
                    </svg>
                    <span style={{fontSize:11, color:predictions.pctChange>0?'#ECFDF5':'#EF4444', fontWeight:800, letterSpacing:'0.02em'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:10}}>
              {[
                {l:'Lucro bruto', sub:'Soma de lucros', v:`R$ ${fmt(stats.lucro)}`, accent:'#ECFDF5'},
          ...
          <div className="g-side" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,marginBottom:24}}>
            ...
            <div className="card a4" style={{
              ...
              background:'linear-gradient(145deg, rgba(14,22,38,0.75), rgba(8,14,26,0.75))',
              backdropFilter:'blur(20px) saturate(150%)', WebkitBackdropFilter:'blur(20px) saturate(150%)',
              border:`1px solid ${goalData.pct>=100?'rgba(236,253,245,0.25)':'rgba(236,253,245,0.14)'}`,
              boxShadow:`0 8px 28px rgba(0,0,0,0.4), 0 0 36px rgba(236,253,245,${goalData.pct>=100?'0.1':'0.04'}), inset 0 1px 0 rgba(255,255,255,0.04)`,
            }}>
              <div style={{ position:'absolute', top:0, left:'15%', right:'15%', height:1, background:'linear-gradient(90deg, transparent, rgba(236,253,245,0.45), transparent)', pointerEvents:'none' }}/>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:18, flexWrap:'wrap', gap:10}}>
                <div style={{display:'flex',alignItems:'center',gap:12}}>
                  <div style={{
                    ...
                    display:'flex', alignItems:'center', justifyContent:'center',
                    boxShadow:'0 0 16px rgba(236,253,245,0.18)',
                  }}>
                ...
                <motion.button
                  ...
                  onMouseEnter={e=>{ e.currentTarget.style.background='rgba(236,253,245,0.08)'; e.currentTarget.style.color='#ECFDF5'; e.currentTarget.style.borderColor='rgba(236,253,245,0.22)' }}
              ...
              <div className="progress" style={{height:8,marginBottom:14}}>
                <div className="progress-bar" style={{width:`${goalData.pct}%`,background:'linear-gradient(90deg,var(--profit),#4ADE80)',boxShadow:'0 0 12px rgba(236,253,245,0.3)'}}/>
              </div>
          ...
          {!isPro && <div className="g-4" style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:14,marginBottom:24}}>
            <ProLockedCard title="Projecao de lucro" description="Veja quanto voce pode faturar nos proximos 30 dias mantendo o ritmo atual. Projecao automatica baseada nas suas metas fechadas." icon="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z">
              <div><div style={{height:14,width:'55%',background:'rgba(236,253,245,0.08)',borderRadius:3,marginBottom:5}}/><div style={{height:18,width:'40%',background:'rgba(236,253,245,0.06)',borderRadius:3}}/></div>
            </ProLockedCard>
              ...
              <div style={{height:200}}>
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData.slice(-14)}>
                    <defs>
                      <linearGradient id="gProfit" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#ECFDF5" stopOpacity={0.3}/><stop offset="100%" stopColor="#ECFDF5" stopOpacity={0}/></linearGradient>
                    </defs>
                    ...
                    <Area type="monotone" dataKey="liquido" name="Liquido" stroke="#ECFDF5" fill="url(#gProfit)" strokeWidth={2}/>
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div style={{height:360}}>
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData}>
                    <defs>
                      <linearGradient id="gL" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#ECFDF5" stopOpacity={0.25}/><stop offset="100%" stopColor="#ECFDF5" stopOpacity={0}/></linearGradient>
                    ...
                    <Tooltip content={<ChartTooltip/>}/>
                    <Area type="monotone" dataKey="lucro" name="Lucro" stroke="#ECFDF5" fill="url(#gL)" strokeWidth={2}/>
              ...
              <div style={{height:280}}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={chartData} barGap={4}>
                    ...
                    <Tooltip content={<ChartTooltip/>}/>
                    <Bar dataKey="lucro" name="Lucro" fill="#ECFDF5" radius={[4,4,0,0]} maxBarSize={32}/>
