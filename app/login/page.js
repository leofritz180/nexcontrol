...
function Particles() {
  const dots = useMemo(() => [
    ...
    { size: 2, x: '8%',  y: '70%', color: 'rgba(16,185,129,0.35)',  dur: 8, del: 1 },
    { size: 4, x: '88%', y: '28%', color: 'rgba(229,57,53,0.25)', dur: 7, del: 0.5 },
    { size: 2, x: '85%', y: '78%', color: 'rgba(239,68,68,0.3)',  dur: 5, del: 2 },
    { size: 3, x: '5%',  y: '50%', color: 'rgba(16,185,129,0.25)',  dur: 9, del: 0.3 },
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              ...
              <span style={{ fontSize: 11, color: 'rgba(16,185,129,0.6)', fontWeight: 600, letterSpacing: '0.06em' }}>
