...
function MilestoneBadge({ label, achieved }) {
  return (
    <div style={{
      ...
      background: achieved ? 'rgba(236,253,245,0.08)' : 'var(--raised)',
      ...
      <div style={{
        ...
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        background: achieved ? 'rgba(236,253,245,0.15)' : 'transparent',
...
function DemoOperatorDashboard({ onCreateMeta }) {
  ...
  const insightColors = { profit: '#ECFDF5', loss: '#EF4444', warn: 'rgba(255,255,255,0.78)', info: '#e53935' }
    ...
    <div>
      ...
      <div className="nxc-demo-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 20 }}>
        ...
        <div>
          ...
          >
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: 'linear-gradient(90deg, #ECFDF5, rgba(236,253,245,0.3))' }} />
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ height: 8, borderRadius: 4, background: 'var(--b1)', overflow: 'hidden' }}>
                <motion.div
                  ...
                  style={{ height: '100%', borderRadius: 4, background: 'linear-gradient(90deg, #ECFDF5, #00A06D)' }}
                />
              </div>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 14 }}>
              <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#ECFDF5', animation: 'demoPulse 2s infinite' }} />
                  ...
                  <form onSubmit={handleCreate} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                    ...
                    <div style={{ padding: '16px 18px', borderRadius: 12, background: 'rgba(255,255,255,0.02)', border: '1px solid var(--b1)' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        {[
                          { text: 'Lucro ou ate R$ 5/conta', sub: 'Bom resultado', color: 'var(--profit)', dot: 'rgba(236,253,245,0.5)' },
                      ...
                      >
                          ...
                          <div style={{ height: 8, borderRadius: 4, background: 'var(--b1)', overflow: 'hidden' }}>
                            <motion.div
                              ...
                              style={{
                                ...
                                background: 'linear-gradient(90deg, #ECFDF5, #00A06D)',
                              }}
                            />
                          </div>
                        </div>
                        ...
                        <button
                          ...
                          style={{
                            ...
                            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                            fontSize: 14, fontWeight: 700, color: '#fff',
                            background: '#ECFDF5', border: 'none', borderRadius: 11,
                            cursor: 'pointer', boxShadow: '0 4px 16px rgba(236,253,245,0.3)',
                            transition: 'all 0.2s ease',
                          }}
