...
const planColors = {
  PRO: { bg: 'rgba(34,197,94,0.08)', c: '#22C55E', b: 'rgba(34,197,94,0.2)' },
  TRIAL: { bg: 'rgba(245,158,11,0.08)', c: '#F59E0B', b: 'rgba(245,158,11,0.2)' },
              ...
              {filtered.slice(0, 3).map((a, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{ fontFamily: 'var(--mono)', fontSize: 16, fontWeight: 800, color: '#22C55E', margin: '8px 0 6px' }}>{a.metas} metas</p>
                    <p style={{ fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700, color: (a.lucroFinal || 0) >= 0 ? '#22C55E' : '#EF4444', margin: '0 0 8px' }}>{(a.lucroFinal || 0) >= 0 ? '+' : ''}R$ {fmt(a.lucroFinal || 0)}</p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
                {[
                  { l: 'Pago', v: `R$ ${fmt(selectedAdmin.totalPaid)}`, c: selectedAdmin.totalPaid > 0 ? '#22C55E' : '#64748B', mono: true },
