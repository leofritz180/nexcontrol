  ...
  return (
    <motion.div
      ...
      style={{
        padding: '16px 18px',
        borderRadius: 12,
        background: achieved ? 'rgba(0,140,94,0.06)' : 'var(--surface)',
        border: `1px solid ${achieved ? 'rgba(0,140,94,0.2)' : 'var(--b1)'}`,
        boxShadow: achieved ? '0 0 20px rgba(0,140,94,0.06)' : 'none',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: achieved ? 0 : 10 }}>
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          background: achieved ? 'rgba(0,140,94,0.15)' : 'var(--raised)',
          border: `1px solid ${achieved ? 'rgba(0,140,94,0.3)' : 'var(--b1)'}`,
                ...
                <>
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      background: 'rgba(0,140,94,0.06)', border: '1px solid rgba(0,140,94,0.2)',
                      ...
                      <span style={{ fontSize: 13, fontWeight: 700, color: '#008C5E' }}>
                        {slotStats[0].name}
                      </span>
                      ...
                      {slotStats.map((s, i) => (
                        ...
                        >
                          ...
                          <span style={{
                            ...
                            color: s.perConta >= 0 ? '#008C5E' : '#EF4444',
                          }}>
                          ...
                          <div style={{ marginBottom: 12 }}>
                            ...
                            <div style={{
                              ...
                              <div style={{
                                ...
                                background: prog.pct >= 80 ? '#008C5E' : prog.pct >= 50 ? 'rgba(255,255,255,0.78)' : '#e53935',
                                transition: 'width 0.6s ease',
                              }} />
                            </div>
                          </div>
