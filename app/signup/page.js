...
function Particles() {
  const dots = useMemo(() => [
    ...
    { size:2, x:'8%', y:'72%', color:'rgba(34,197,94,0.3)', dur:6, del:1 },
    { size:3, x:'90%', y:'70%', color:'rgba(229,57,53,0.2)', dur:9, del:2 },
    { size:2, x:'50%', y:'88%', color:'rgba(34,197,94,0.2)', dur:10, del:1.5 },
  ], [])
  return dots.map((d, i) => (
    <motion.div key={i}
  ...
  return (
    <main style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:24, position:'relative', zIndex:1, overflow:'hidden' }}>
      ...
      >
        ...
        >
          <div style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'6px 14px', borderRadius:8, background:'rgba(34,197,94,0.04)', border:'1px solid rgba(34,197,94,0.1)' }}>
            ...
            <span style={{ fontSize:9, fontWeight:700, color:'rgba(34,197,94,0.6)', letterSpacing:'0.06em', textTransform:'uppercase' }}>Conexão segura · Dados criptografados</span>
          </div>
        </motion.div>
