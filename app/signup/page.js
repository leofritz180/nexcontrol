...
function Particles() {
  const dots = useMemo(() => [
    ...
    { size:2, x:'8%', y:'72%', color:'rgba(209,250,229,0.3)', dur:6, del:1 },
    { size:3, x:'90%', y:'70%', color:'rgba(229,57,53,0.2)', dur:9, del:2 },
    { size:2, x:'50%', y:'88%', color:'rgba(209,250,229,0.2)', dur:10, del:1.5 },
  ], [])
  return dots.map((d, i) => (
    <motion.div key={i}
...
export default function SignupPage() {
  ...
  return (
    <main style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:24, position:'relative', zIndex:1, overflow:'hidden' }}>
      ...
      <div style={{ position:'fixed', bottom:'-18%', right:'-8%', width:650, height:650, borderRadius:'50%', background:'radial-gradient(circle, rgba(209,250,229,0.12) 0%, transparent 65%)', filter:'blur(60px)', pointerEvents:'none', animation:'lpOrb2 25s ease-in-out infinite' }}/>
      ...
      >
        ...
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:6, marginTop:6 }}>
            <span style={{ width:5, height:5, borderRadius:'50%', background:'#D1FAE5', boxShadow:'0 0 6px rgba(209,250,229,0.5)' }}/>
        ...
        >
          <div style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'6px 14px', borderRadius:8, background:'rgba(209,250,229,0.04)', border:'1px solid rgba(209,250,229,0.1)' }}>
            ...
            <span style={{ fontSize:9, fontWeight:700, color:'rgba(209,250,229,0.6)', letterSpacing:'0.06em', textTransform:'uppercase' }}>Conexão segura · Dados criptografados</span>
          </div>
        </motion.div>
