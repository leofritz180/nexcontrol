...
function SlotCard({ slot, index, isPro }) {
  ...
  const lvColor = isAlta ? '#008c5e' : slot.performance === 'baixa' ? '#60a5fa' : 'rgba(255,255,255,0.78)'
        ...
        {locked ? (
          ...
          <motion.button
            ...
            style={{
              ...
              background: copied ? 'rgba(0,140,94,0.12)' : 'rgba(229,57,53,0.08)',
              color: copied ? '#008c5e' : '#e53935',
              border: `1px solid ${copied ? 'rgba(0,140,94,0.2)' : 'rgba(229,57,53,0.15)'}`,
              display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
              transition: 'all 0.2s',
            }}
          >
          ...
          <>
            ...
            <motion.div {...fadeUp(3)} style={{
              ...
              {[
                ...
                { label: 'Alta performance', value: filtered.filter(s => s.performance === 'alta').length, color: '#008c5e' },
