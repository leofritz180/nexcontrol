      ...
      <div style={{ maxWidth: nex2 ? 1380 : 860, margin: '0 auto', padding: nex2 ? '32px 28px' : '40px 24px 80px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{
                ...
                background: allDone ? 'rgba(209,250,229,0.12)' : 'rgba(255,255,255,0.1)',
                border: `1px solid ${allDone ? 'rgba(209,250,229,0.25)' : 'rgba(255,255,255,0.2)'}`,
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
                {allDone ? (
            ...
            {STEPS.map((step, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{
                    background: done ? 'rgba(209,250,229,0.06)' : 'rgba(255,255,255,0.06)',
                    x: 4,
                  ...
                  style={{
                    ...
                    background: done ? 'rgba(209,250,229,0.04)' : 'transparent',
                    border: `1px solid ${done ? 'rgba(209,250,229,0.12)' : 'rgba(255,255,255,0.04)'}`,
                ...
                >
                  ...
                  <motion.div
                    animate={{
                      background: done ? 'rgba(209,250,229,0.2)' : 'rgba(255,255,255,0.04)',
                      borderColor: done ? 'rgba(209,250,229,0.4)' : 'rgba(255,255,255,0.12)',
                    }}
            ...
            {allDone && (
              <motion.div
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, rgba(209,250,229,0.1), rgba(209,250,229,0.04))',
                  border: '1px solid rgba(209,250,229,0.2)',
                  boxShadow: '0 0 30px rgba(209,250,229,0.06)',
                  display: 'flex', alignItems: 'center', gap: 14,
                }}
              >
                <motion.div
                  animate={{
                    boxShadow: [
                      '0 0 0 0 rgba(209,250,229,0.3)',
                      '0 0 0 8px rgba(209,250,229,0)',
                      '0 0 0 0 rgba(209,250,229,0)',
                    ],
                  }}
        ...
        >
          {[
            ...
            { label: 'Minha operação', href: '/operator', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', color: 'var(--profit)' },
