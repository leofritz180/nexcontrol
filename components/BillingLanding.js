    ...
    <div style={{ maxWidth:1100, margin:'0 auto', padding:'0 28px 80px' }}>
      ...
      <motion.div {...fadeUp()} style={{ textAlign:'center', padding:'60px 0 50px' }}>
        ...
        <motion.p
          ...
          style={{ fontFamily:'var(--mono)', fontSize:56, fontWeight:900, color:'#008C5E', lineHeight:1, margin:'0 0 10px',
            textShadow:'0 0 50px rgba(0,140,94,0.2), 0 0 100px rgba(0,140,94,0.1)',
          }}>
          +R$ 3.058,47
        </motion.p>
      ...
      <section style={{ padding:'40px 0 60px', position:'relative' }}>
        <div style={{ position:'absolute', top:'20%', right:'15%', width:440, height:440, borderRadius:'50%', background:'radial-gradient(circle, rgba(0,140,94,0.08), transparent 55%)', filter:'blur(70px)', pointerEvents:'none' }}/>
        ...
        <div className="g-side" style={{ display:'grid', gridTemplateColumns:'1fr 1.1fr', gap:56, alignItems:'center', position:'relative' }}>
          ...
          {/* Copy — vendedor */}
          <motion.div {...fadeUp()}>
            <div style={{ display:'inline-flex', alignItems:'center', gap:7, padding:'5px 12px', borderRadius:99, background:'rgba(0,140,94,0.08)', border:'1px solid rgba(0,140,94,0.2)', marginBottom:18 }}>
              <motion.div
                animate={{ boxShadow:['0 0 0 0 rgba(0,140,94,0.55)','0 0 0 5px rgba(0,140,94,0)','0 0 0 0 rgba(0,140,94,0)'] }}
                transition={{ duration:1.8, repeat:Infinity, ease:'easeInOut' }}
                style={{ width:6, height:6, borderRadius:'50%', background:'#008C5E' }}
              />
              <span style={{ fontSize:10, color:'#008C5E', fontWeight:800, letterSpacing:'0.1em' }}>AO VIVO NO SEU BOLSO</span>
            </div>
            ...
            <h2 style={{ fontSize:34, fontWeight:900, color:'var(--t1)', margin:'0 0 14px', letterSpacing:'-0.035em', lineHeight:1.1 }}>
              ...
              <span style={{ background:'linear-gradient(135deg, #008C5E, #4ADE80)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', backgroundClip:'text' }}>em tempo real</span>
            </h2>
            <p style={{ fontSize:15, color:'var(--t2)', lineHeight:1.6, margin:'0 0 28px' }}>
              Cada remessa registrada vira uma <strong style={{ color:'#fff' }}>notificação instantânea</strong> no seu celular. Você acompanha tudo ao vivo — <strong style={{ color:'#008C5E' }}>operador, rede e lucro</strong>.
            </p>
            ...
            {[
              ...
              <motion.div key={t}
                ...
                <div style={{ width:22, height:22, borderRadius:6, background:'rgba(0,140,94,0.12)', border:'1px solid rgba(0,140,94,0.28)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0, marginTop:2, boxShadow:'0 0 10px rgba(0,140,94,0.12)' }}>
          ...
          <motion.div {...fadeUp(0.2)} style={{ display:'flex', justifyContent:'center', perspective:1400 }}>
            <motion.div
              ...
              style={{
                ...
                boxShadow:`0 50px 120px rgba(0,0,0,0.7), 0 0 0 1px rgba(229,57,53,0.04), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 ${flash?'80':'40'}px rgba(0,140,94,${flash?'0.18':'0.05'})`,
                ...
                <AnimatePresence>
                  {flash && (
                    <motion.div initial={{opacity:0.3}} animate={{opacity:0}} exit={{opacity:0}} transition={{duration:0.9}}
                      style={{ position:'absolute', inset:0, background:'radial-gradient(circle at 50% 15%, rgba(0,140,94,0.22), transparent 58%)', zIndex:10, pointerEvents:'none' }}/>
                  )}
                </AnimatePresence>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:7 }}>
                    ...
                    <div>
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:4, marginTop:1 }}>
                        <motion.div
                          animate={{ boxShadow:['0 0 0 0 rgba(0,140,94,0.6)','0 0 0 3px rgba(0,140,94,0)','0 0 0 0 rgba(0,140,94,0)'] }}
                          transition={{ duration:1.6, repeat:Infinity, ease:'easeInOut' }}
                          style={{ width:4, height:4, borderRadius:'50%', background:'#008C5E' }}
                        />
                        <span style={{ fontSize:7, color:'rgba(0,140,94,0.8)', fontWeight:700, letterSpacing:'0.08em' }}>TEMPO REAL</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div key={idx}
                      ...
                      style={{
                        ...
                        border:'1px solid rgba(0,140,94,0.22)',
                        boxShadow:'0 8px 24px rgba(0,0,0,0.4), 0 0 20px rgba(0,140,94,0.1)',
                      }}>
                      <div style={{ display:'flex', alignItems:'center', gap:7, marginBottom:4 }}>
                        ...
                        <span style={{ fontSize:7, color:'rgba(0,140,94,0.9)', fontWeight:700, marginLeft:'auto' }}>agora</span>
                      </div>
                      ...
                      <p style={{ fontSize:8, color:'rgba(255,255,255,0.55)', margin:0, paddingLeft:23 }}>
                        <span style={{ color: FEED_DATA[idx % FEED_DATA.length].pos ? '#008C5E' : '#EF4444', fontWeight:800, fontSize:10 }}>
                ...
                <div style={{ padding:'14px 14px 18px' }}>
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      background:'linear-gradient(145deg, rgba(0,140,94,0.12), rgba(14,22,38,0.8))',
                      border:'1px solid rgba(0,140,94,0.24)',
                      boxShadow:`0 6px 20px rgba(0,0,0,0.35), 0 0 ${flash?'30':'14'}px rgba(0,140,94,${flash?'0.25':'0.08'})`,
                      transition:'box-shadow 0.4s',
                    }}>
                    <div style={{ position:'absolute', top:0, left:'20%', right:'20%', height:1, background:'linear-gradient(90deg, transparent, rgba(0,140,94,0.4), transparent)' }}/>
                    ...
                    <motion.p
                      animate={flash?{ textShadow:['0 0 10px rgba(0,140,94,0.25)','0 0 28px rgba(0,140,94,0.55)','0 0 10px rgba(0,140,94,0.25)'] }:{}}
                      transition={{duration:0.8}}
                      style={{
                        fontFamily:'var(--mono)', fontSize:26, fontWeight:900, color:'#008C5E', margin:0,
                        letterSpacing:'-0.03em', lineHeight:1,
                        textShadow:'0 0 18px rgba(0,140,94,0.3)',
                      }}>
                      +R$ {total.toLocaleString('pt-BR')}
                    </motion.p>
                    <p style={{ fontSize:8, color:'rgba(0,140,94,0.75)', margin:'5px 0 0', fontWeight:600 }}>
                      ↑ atualizado ha 2s
                    </p>
                  </motion.div>
                  ...
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:8 }}>
                    ...
                    <motion.div
                      animate={{ boxShadow:['0 0 0 0 rgba(0,140,94,0.5)','0 0 0 4px rgba(0,140,94,0)','0 0 0 0 rgba(0,140,94,0)'] }}
                      transition={{ duration:1.8, repeat:Infinity, ease:'easeInOut' }}
                  ...
                  <div style={{ display:'flex', flexDirection:'column', gap:0 }}>
                    {FEED_DATA.slice(0,4).map((item,i) => {
                      const ac = item.pos ? '#008C5E' : '#EF4444'
                      return (
              ...
              <div style={{ position:'absolute', bottom:'30%', right:-30, width:60, height:120, borderRadius:'50%', background:'radial-gradient(circle, rgba(0,140,94,0.14), transparent 65%)', filter:'blur(24px)', pointerEvents:'none' }}/>
            </motion.div>
          </motion.div>
        </div>
      </section>
