      ...
      <div className="g-4" style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:14, marginBottom:60 }}>
        {[
          ...
          <motion.div key={i} {...fadeUp(i*0.04)}
            ...
            style={{ padding:'20px 18px', borderRadius:12, background:'linear-gradient(145deg, var(--surface), var(--surface))', border:'1px solid var(--b1)', boxShadow:'0 4px 16px rgba(0,0,0,0.25)' }}>
        ...
        <div className="g-side" style={{ display:'grid', gridTemplateColumns:'1fr 1.1fr', gap:56, alignItems:'center', position:'relative' }}>
          ...
          <motion.div {...fadeUp()}>
            ...
            <p style={{ fontSize:15, color:'var(--t2)', lineHeight:1.6, margin:'0 0 28px' }}>
              Cada remessa registrada vira uma <strong style={{ color:'var(--t1)' }}>notificação instantânea</strong> no seu celular. Você acompanha tudo ao vivo — <strong style={{ color:'var(--profit)' }}>operador, rede e lucro</strong>.
            </p>
          ...
          <motion.div {...fadeUp(0.2)} style={{ display:'flex', justifyContent:'center', perspective:1400 }}>
            <motion.div
              ...
              {/* Subtle top speaker */}
              <div style={{ width:60, height:5, borderRadius:3, background:'var(--fill-2)', margin:'0 auto 10px' }}/>
              ...
              <div style={{
                ...
                <div style={{ padding:'12px 14px 8px', borderBottom:'1px solid var(--b1)', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
                  <div style={{ display:'flex', alignItems:'center', gap:7 }}>
                    ...
                    <div>
                      <p style={{ fontSize:10, fontWeight:800, color:'var(--t1)', margin:0, letterSpacing:'-0.01em' }}>NexControl</p>
                      <div style={{ display:'flex', alignItems:'center', gap:4, marginTop:1 }}>
                        ...
                        />
                        <span style={{ fontSize:7, color:'var(--t1)', fontWeight:700, letterSpacing:'0.08em' }}>TEMPO REAL</span>
                      </div>
                    </div>
                  </div>
                  <span style={{ fontSize:7, color:'var(--t4)', fontFamily:'var(--mono)' }}>{new Date().getHours().toString().padStart(2,'0')}:{new Date().getMinutes().toString().padStart(2,'0')}</span>
                </div>
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div key={idx}
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:7, marginBottom:4 }}>
                        ...
                        <span style={{ fontSize:7, color:'var(--t1)', fontWeight:700, marginLeft:'auto' }}>agora</span>
                      </div>
                      <p style={{ fontSize:10, fontWeight:700, color:'var(--t1)', margin:'0 0 2px', paddingLeft:23 }}>
                        {FEED_DATA[idx % FEED_DATA.length].rede} · {FEED_DATA[idx % FEED_DATA.length].name}
                      </p>
                      <p style={{ fontSize:8, color:'var(--t2)', margin:0, paddingLeft:23 }}>
                ...
                <div style={{ padding:'14px 14px 18px' }}>
                  ...
                  <motion.div
                    ...
                    <p style={{ fontSize:8, color:'var(--t3)', margin:'0 0 5px', fontWeight:700, letterSpacing:'0.1em', textTransform:'uppercase' }}>Lucro de hoje</p>
                    <motion.p
                    ...
                    <p style={{ fontSize:8, color:'var(--t1)', margin:'5px 0 0', fontWeight:600 }}>
                      ↑ atualizado ha 2s
                    </p>
                  </motion.div>
                  ...
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:8 }}>
                    <span style={{ fontSize:8, fontWeight:800, color:'var(--t2)', letterSpacing:'0.1em', textTransform:'uppercase' }}>Atividade ao vivo</span>
                    <motion.div
                        ...
                        <motion.div key={`${item.rede}-${item.name}-${i}`}
                          ...
                          <div style={{ display:'flex', alignItems:'center', gap:7, minWidth:0 }}>
                            ...
                            <div style={{ minWidth:0 }}>
                              <p style={{ fontSize:9, fontWeight:700, color:'var(--t1)', margin:0, letterSpacing:'-0.01em' }}>{item.rede} · {item.name}</p>
                              <p style={{ fontSize:7, color:'var(--t3)', margin:0, fontFamily:'var(--mono)' }}>{item.t}</p>
                            </div>
                          </div>
                          <span style={{
              ...
              <div style={{ width:90, height:4, borderRadius:2, background:'var(--fill-3)', margin:'12px auto 0' }}/>
      ...
      <div className="g-4" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:14, marginBottom:48 }}>
        {[
          ...
          <motion.div key={i} {...fadeUp(i*0.08)}
            style={{ padding:'22px 20px', borderRadius:12, background:'linear-gradient(145deg, var(--surface), var(--surface))', border:'1px solid var(--b1)' }}>
              ...
              <motion.div key={slot.id} {...fadeUp(0.1 + i * 0.06)} style={{
                ...
                <div style={{ position: 'absolute', inset: 0, zIndex: 5, pointerEvents: 'none', overflow: 'hidden', borderRadius: 14 }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(105deg, transparent 40%, var(--fill-1) 48%, rgba(255,255,255,0.05) 50%, rgba(255,255,255,0.03) 52%, transparent 60%)',
                ...
                <div style={{ aspectRatio: '16/10', position: 'relative', overflow: 'hidden' }}>
                  ...
                  <span style={{
                    ...
                    fontSize: 8, fontWeight: 700, color: 'var(--t2)', textTransform: 'uppercase',
