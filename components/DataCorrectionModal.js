  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{ position: 'fixed', inset: 0, zIndex: 9500, background: 'rgba(17,19,24,0.55)', backdropFilter: 'blur(6px)', WebkitBackdropFilter: 'blur(6px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}
      >
        <motion.div
