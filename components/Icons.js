...
export function IconTarget({ size=44 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={{filter:'drop-shadow(0 4px 12px rgba(255,255,255,0.4))'}}>
      <ellipse cx="24" cy="42" rx="14" ry="4" fill="rgba(255,255,255,0.78)" opacity="0.2"/>
...
export function IconLock({ size=44 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={{filter:'drop-shadow(0 4px 12px rgba(255,255,255,0.35))'}}>
      ...
      <ellipse cx="24" cy="42" rx="13" ry="3.5" fill="rgba(255,255,255,0.78)" opacity="0.18"/>
