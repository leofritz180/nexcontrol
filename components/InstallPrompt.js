    ...
    <div style={{
      ...
      <div style={{ flex: 1, padding: '8px 12px', position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 5, marginBottom: 10 }}>
          <div style={{ padding: '7px 6px', borderRadius: 8, background: 'rgba(0,140,94,0.06)', border: '1px solid rgba(0,140,94,0.1)' }}>
            <div style={{ fontSize: 6, color: 'rgba(255,255,255,0.3)', marginBottom: 2 }}>LUCRO</div>
            <div style={{ fontSize: 11, fontWeight: 800, color: '#008c5e', fontFamily: 'var(--mono, monospace)' }}>+R$ 1.840</div>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 2.5, height: 30, marginBottom: 8 }}>
          {[30, 50, 40, 65, 55, 80, 70, 90].map((h, i) => (
            <div key={i} style={{ flex: 1, height: `${h}%`, borderRadius: 2, background: `rgba(0,140,94,${0.1 + i * 0.04})` }} />
          ))}
        </div>
        {/* List */}
        {[1, 2].map(i => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '5px 0', borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
            ...
            <span style={{ fontSize: 7, fontWeight: 700, color: '#008c5e' }}>+R${i * 120 + 90}</span>
          </div>
        ))}
        {/* Notification */}
        <AnimatePresence>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 24 }}>
                    {[
                      ...
                      <div key={i} style={{ padding: '11px 12px', borderRadius: 12, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', gap: 9 }}>
                        <svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="#008c5e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, opacity: 0.6 }}><path d={b.icon} /></svg>
              ...
              >
                <div style={{ padding: '32px 26px 28px' }}>
                  ...
                  <div style={{
                    ...
                    background: isIos ? 'rgba(255,255,255,0.04)' : 'rgba(0,140,94,0.06)',
                    border: `1px solid ${isIos ? 'rgba(255,255,255,0.08)' : 'rgba(0,140,94,0.12)'}`,
                  }}>
                    <svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke={isIos ? 'rgba(255,255,255,0.5)' : '#008c5e'} strokeWidth="1.8" strokeLinecap="round">
                      <rect x="5" y="2" width="14" height="20" rx="2" />
                      <line x1="12" y1="18" x2="12" y2="18.01" />
                    </svg>
                    <span style={{ fontSize: 11, fontWeight: 600, color: isIos ? 'rgba(255,255,255,0.5)' : '#008c5e' }}>
                  ...
                  <div style={{
                    ...
                    background: 'rgba(0,140,94,0.04)', border: '1px solid rgba(0,140,94,0.1)',
                    display: 'flex', alignItems: 'flex-start', gap: 10,
                  }}>
                    <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="#008c5e" strokeWidth="1.8" strokeLinecap="round" style={{ flexShrink: 0, marginTop: 1 }}>
                    ...
                    <div>
                      <p style={{ fontSize: 12, fontWeight: 600, color: '#008c5e', margin: '0 0 3px' }}>Dica</p>
