    ...
    return (
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 4px 20px rgba(0,0,0,0.35), 0 0 30px rgba(236,253,245,0.04), inset 0 1px 0 rgba(255,255,255,0.03)',
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <motion.div
            animate={{ boxShadow: ['0 0 0 0 rgba(236,253,245,0)', '0 0 0 8px rgba(236,253,245,0.2)', '0 0 0 0 rgba(236,253,245,0)'] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
            style={{ width: 12, height: 12, borderRadius: '50%', background: '#ECFDF5', flexShrink: 0 }}
          />
          <div>
        ...
        <div style={{ textAlign: 'right' }}>
          <p style={{
            ...
            fontSize: 36, fontWeight: 900, color: '#ECFDF5', margin: 0, lineHeight: 1,
            textShadow: '0 0 20px rgba(236,253,245,0.15)',
          }}>
            {count}
          </p>
        </div>
  ...
  return (
    ...
    >
      <span style={{
        ...
        background: '#ECFDF5',
        boxShadow: '0 0 6px rgba(236,253,245,0.5)',
        animation: 'onlinePulse 2s ease-in-out infinite',
      }} />
      <span style={{ fontFamily: 'var(--mono, monospace)', fontWeight: 700, color: '#ECFDF5' }}>{count}</span>
