          ...
          <div style={{ padding: '26px 24px 28px' }}>
            ...
            {step === 'intro' && (
              <div style={{ animation: 'pix-fade-in 0.3s ease-out both' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, marginTop: 16, padding: '8px 14px', borderRadius: 10, background: 'rgba(0,140,94,0.04)', border: '1px solid rgba(0,140,94,0.1)' }}>
                  ...
                  <span style={{ fontSize: 11, color: 'rgba(0,140,94,0.75)', fontWeight: 600, letterSpacing: '0.02em' }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                      transition: 'all 0.2s',
                      background: copied ? 'rgba(0,140,94,0.15)' : 'linear-gradient(145deg, #e53935, #c62828)',
                      color: copied ? '#008C5E' : 'white',
                      boxShadow: copied
                        ? '0 0 0 1px rgba(0,140,94,0.3) inset'
            ...
            {step === 'paid' && (
              <div style={{ textAlign: 'center', padding: '8px 0', animation: 'pix-fade-in 0.35s ease-out both' }}>
                <div style={{
                  ...
                  background: 'rgba(0,140,94,0.15)', border: '2px solid rgba(0,140,94,0.4)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  margin: '0 auto 18px',
                  animation: 'pix-pop 0.5s cubic-bezier(0.33,1.4,0.68,1) both',
                  boxShadow: '0 0 40px rgba(0,140,94,0.25)',
                }}>
                  <svg width={34} height={34} viewBox="0 0 24 24" fill="none" stroke="#008C5E" strokeWidth="3" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg>
                </div>
                <h3 style={{ fontSize: 19, fontWeight: 800, color: '#008C5E', margin: '0 0 6px' }}>
                  ✅ Pagamento confirmado!
                </h3>
                <p style={{ fontSize: 13, color: '#94A3B8', margin: '0 0 18px' }}>
                  Liberando acesso...
                </p>
                <div style={{ width: '100%', height: 3, borderRadius: 2, overflow: 'hidden', background: 'rgba(0,140,94,0.08)' }}>
                  <div style={{ height: '100%', background: '#008C5E', animation: 'pix-bar 1.8s linear both', transformOrigin: 'left' }}/>
                </div>
              </div>
            )}
