...
export default function PushManager({ userId, tenantId }) {
  ...
  const closeBtn = (
    <button onClick={dismiss} aria-label="Fechar" style={{
      position:'absolute', top:0, right:0, width:40, height:40, background:'none', border:'none',
      cursor:'pointer', padding:0, display:'flex', alignItems:'center', justifyContent:'center', lineHeight:1, color:'var(--t4)',
    }}>
