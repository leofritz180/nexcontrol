...
const FREE_PATHS = ['/login', '/signup', '/invite', '/billing', '/billing-mp', '/', '/owner', '/slots', '/proxy', '/minhas-proxies', '/performance', '/aulas', '/demo', '/reset-password', '/network', '/premiacoes', '/termos', '/privacidade', '/design-v2', '/v2', '/convite', '/grupo']
