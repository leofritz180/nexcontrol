...
const CFG = {
  green:  { bg:'rgba(236,253,245,0.06)', border:'rgba(236,253,245,0.15)', color:'var(--profit)', rgb:'34,197,94' },
        ...
        >
          ...
          {(moved > 0 || metas > 0) && (
            <div style={{ padding: '0 32px 12px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
                {[
                  { l: 'Movimentado', v: `R$ ${Number(moved).toLocaleString('pt-BR', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`, c: '#ECFDF5' },
          ...
          <div style={{ padding: '18px 32px 0' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', padding: '14px 18px', borderRadius: 12, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <span style={{ fontFamily: 'var(--mono)', fontSize: 24, fontWeight: 900, color: '#ECFDF5', letterSpacing: '-0.02em' }}>R$ 39,90</span>
          ...
          <div style={{ padding: '18px 32px 28px' }}>
            <motion.button
              ...
              whileHover={{ scale: 1.015, boxShadow: '0 0 0 1px rgba(236,253,245,0.35), 0 12px 28px rgba(236,253,245,0.28), 0 0 42px rgba(236,253,245,0.22)' }}
              whileTap={{ scale: 0.98 }}
              ...
              style={{
                ...
                background: 'linear-gradient(180deg, #ecfdf5, #00a06d)',
                color: '#04120a',
                fontSize: 15, fontWeight: 800,
                display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 10,
                boxShadow: '0 0 0 1px rgba(236,253,245,0.2), 0 8px 22px rgba(236,253,245,0.22), 0 0 30px rgba(236,253,245,0.18)',
