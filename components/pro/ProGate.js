          ...
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10 }}>
            {icon && (
              <div style={{
                ...
                <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke={hovered?'#ff4444':'var(--profit)'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" style={{ transition:'stroke 0.3s' }}>
                  <path d={icon}/>
                </svg>
              </div>
            )}
