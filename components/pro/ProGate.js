      ...
      >
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10 }}>
            {icon && (
              <div style={{
                ...
                background: hovered?'rgba(229,57,53,0.1)':'rgba(0,140,94,0.08)',
                border:`1px solid ${hovered?'rgba(229,57,53,0.2)':'rgba(0,140,94,0.15)'}`,
                display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0,
                transition:'all 0.3s',
              }}>
                <svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke={hovered?'#ff4444':'#008C5E'} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" style={{ transition:'stroke 0.3s' }}>
                  <path d={icon}/>
                </svg>
              </div>
            )}
        ...
        <div style={{ position:'relative', padding:'0 22px 22px' }}>
          <div style={{
            ...
            {children || (
              <div>
                <div style={{ height:14, width:'75%', background:'rgba(0,140,94,0.08)', borderRadius:4, marginBottom:6 }}/>
                <div style={{ height:20, width:'55%', background:'rgba(0,140,94,0.06)', borderRadius:4, marginBottom:6 }}/>
