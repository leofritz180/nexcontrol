...
// .trim() NÃO é decoração: o valor salvo na Vercel termina com uma quebra
// de linha (o `vercel env add` a inclui), enquanto o .env.local não tem. Sem
// isto, o link gerado aqui é assinado com uma chave e conferido com outra —
// e produção responde "convite inválido" pra um token legítimo. Foi
// exatamente o que aconteceu no primeiro link gerado.
const segredo = () => (process.env.SUPABASE_SERVICE_ROLE_KEY || '').trim()
