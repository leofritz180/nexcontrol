...
// Chave do rollout GERAL (General Availability). Quando `true`, o Network abre
// para admins PRO ativos alem da allowlist acima (a checagem de sub ativa fica
// no authNetwork/Sidebar). Por enquanto FALSE — comportamento = so allowlist.
export const NETWORK_GA = false
