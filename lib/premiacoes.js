...
export const PREMIACOES = [
  { id: '10k',   value: 10000,   label: 'R$ 10 mil',   tier: 'Bronze',    color: '#cd7f32', preview: true, available: false, ext: 'png' },
  { id: '20k',   value: 20000,   label: 'R$ 20 mil',   tier: 'Prata',     color: '#c4cdd6', preview: true, available: false, ext: 'png' },
  { id: '50k',   value: 50000,   label: 'R$ 50 mil',   tier: 'Ouro',      color: '#f5b83c', preview: true, available: false, ext: 'png' },
  { id: '100k',  value: 100000,  label: 'R$ 100 mil',  tier: 'Platina',   color: '#5ac8fa', preview: true, available: false, ext: 'png' },
  { id: '200k',  value: 200000,  label: 'R$ 200 mil',  tier: 'Diamante',  color: '#7aa5ff', preview: true, available: false, ext: 'png' },
  { id: '500k',  value: 500000,  label: 'R$ 500 mil',  tier: 'Master',    color: '#b978e6', preview: true, available: false, ext: 'png' },
  { id: '1m',    value: 1000000, label: 'R$ 1 Milhão', tier: 'Lendário',  color: '#ff5b56', preview: true, available: false, ext: 'png' },
]
