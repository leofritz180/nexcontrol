...
// available = já tem arte pra baixar? (false até subirmos os arquivos)
// ext = extensão dos arquivos ('png' | 'jpg') — usada só quando available.
export const PREMIACOES = [
  { id: '10k',   value: 10000,   label: 'R$ 10 mil',   tier: 'Bronze',    color: '#cd7f32', available: false, ext: 'png' },
  { id: '25k',   value: 25000,   label: 'R$ 25 mil',   tier: 'Prata',     color: '#c4cdd6', available: false, ext: 'png' },
  { id: '50k',   value: 50000,   label: 'R$ 50 mil',   tier: 'Ouro',      color: '#f5b83c', available: false, ext: 'png' },
  { id: '100k',  value: 100000,  label: 'R$ 100 mil',  tier: 'Platina',   color: '#5ac8fa', available: false, ext: 'png' },
  { id: '250k',  value: 250000,  label: 'R$ 250 mil',  tier: 'Diamante',  color: '#7aa5ff', available: false, ext: 'png' },
  { id: '500k',  value: 500000,  label: 'R$ 500 mil',  tier: 'Master',    color: '#b978e6', available: false, ext: 'png' },
  { id: '1m',    value: 1000000, label: 'R$ 1 Milhão', tier: 'Lendário',  color: '#ff5b56', available: false, ext: 'png' },
]
