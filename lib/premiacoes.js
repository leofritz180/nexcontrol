...
export const PREMIACOES_EMAILS = new Set([
  'darkzinmg7@gmail.com',
])
// Lançado pra TODOS os admins em 10/07/2026. Pra voltar a fase de teste: PREMIACOES_GA=false.
export const PREMIACOES_GA = true
export function premiacoesEnabled(email) {
  return PREMIACOES_GA || (!!email && PREMIACOES_EMAILS.has(String(email).toLowerCase()))
}
