...
export const RANK_TIERS = [
  ...
  { tier: 15, name: 'Apex',      min: 15000, primary: '#0A0A0A', secondary: '#FFD700', glow: 'rgba(180,120,255,0.7)',  icon: 'apex',          rgb: '180,120,255', signature: 'apex-holo',   particle: 'apex',      idle: 'apex' },
]
