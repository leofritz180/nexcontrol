...
export const RENEWAL_SEGMENTS = {
  ...
  trial_lapsed: {
    push: { title: '{nome}, da pra recomecar', body: 'Voce testou o NexControl. Assine e tenha controle total da operacao.' },
    email: {
      subject: '{nome}, seu teste acabou — mas da pra recomecar',
      preheader: 'Assine a partir de R$ 39,90/mes e retome o controle.',
      bodyTitle: 'Bora colocar sua operacao no controle?',
      bodyText: '{nome}, voce testou o NexControl mas nao chegou a assinar. A plataforma continua aqui pra te dar controle total da operacao: lucro em tempo real, gestao da equipe e cada remessa no lugar certo. Assine a partir de R$ 39,90/mes e comece a operar com clareza hoje mesmo.',
