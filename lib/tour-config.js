...
// ═══════════════════════════════════════
// /admin — Tour cobrindo todas as 4 tabs
// ═══════════════════════════════════════
export const ADMIN_TOUR_STEPS = [
  // ── Tab Visão geral ──
  {
    ...
    description: 'O coração do painel. Lucro líquido (depois de salário, BAU e custos) no período selecionado. Filtros: hoje, ontem, 7d, 30d ou tudo.',
    position: 'right',
  },
  {
    clickBefore: '[data-tour-tab="overview"]',
  ...
  // ── Tab Metas & Fechamento ──
  {
    clickBefore: '[data-tour-tab="operations"]',
    target: '[data-tour="tab-operations"]',
    title: 'Metas & Fechamento',
    description: 'Todas as metas do tenant (suas e da equipe). Aqui você finaliza, fecha financeiramente (salário + BAU + custos) e grava o lucro_final.',
    position: 'auto',
  },
  // ── Tab Lixeira ──
  {
