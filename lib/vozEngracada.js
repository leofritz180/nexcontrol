...
export function repertorioEngracado(f) {
  ...
  return {
    'transmissao': d => [
      { titulo: `${nome(d)} abriu a cortina 🎭`, corpo: 'Tela ao vivo agora. Pega a pipoca e entra na Sala.' },
      { titulo: `Plantão: ${nome(d)} ao vivo 📺`, corpo: 'A tela dele tá passando agora. Sem reprise.' },
      { titulo: `${nome(d)} ligou a câmera (da tela) 🎥`, corpo: 'Entra na Sala pra ver a mágica acontecendo.' },
      { titulo: `Ao vivo e a cores: ${nome(d)} 🔴`, corpo: 'A operação em tempo real, sem edição.' },
    ],
    'meta-criada': d => [
